...
if(isset($_POST["advertise"])){
	 ...
	 $sql = "SELECT * FROM adverts WHERE house='$house'";
   ...
   $row = mysqli_fetch_assoc($result1);
	 ...
	 if ($result->num_rows < 1 ) {
      //  $query = "advertise properties set protype = '$protype',location= '$location',city='$city',propname='$propname',description='$description',status='$status',price='$price' WHERE id = $id";
      $query = "INSERT INTO adverts (username,protype, location, city,propname,description,status,house,price)
      VALUES ('$username','$protype', '$location', '$city','$propname','$description','$status','$house','$price')";
      $data = mysqli_query($conn,$query);
      ...
      if($data)
      {
          ...
          echo
            ...
            <script>
              ...
              document.location.href = 'adview.php';
            </script>
            ";
        ...
        <script>
          ...
          document.location.href = 'advertise.php';
        </script>
        ";
      }
        ...
        ";   
          ...
          "
          <script>
            alert('Not authorised to advertise CONTACT ADMIN! ');
            document.location.href = 'c_admin.php';
          </script>
          ";  
        }
